...
describe('phoneInputHelpers', () => {
  ...
  it('should parse phone numbers', () => {
    const phoneNumber = (0, _phoneInputHelpers.parsePhoneNumber)('+78005553535', _metadata.default);
  ...
  it('should generate national number digits', () => {
    const phoneNumber = (0, _phoneInputHelpers.parsePhoneNumber)('+33509758351', _metadata.default);
  ...
  it('should handle phone digits change (`international: false`)', () => {
    const onChange = (phoneDigits, prevPhoneDigits, country) => (0, _phoneInputHelpers.onPhoneDigitsChange)(phoneDigits, {
      prevPhoneDigits,
      country,
      international: false,
      metadata: _metadata.default
  ...
  it('should handle phone digits change (`international: false` and no country selected)', () => {
    ...
    const onChange = phoneDigits => (0, _phoneInputHelpers.onPhoneDigitsChange)(phoneDigits, {
      prevPhoneDigits: '',
      international: false,
      metadata: _metadata.default
    }); // `phoneDigits` in international format.
  ...
  it('should get initial parsed input (has `phoneNumber` that has no `country`)', () => {
    const phoneNumber = (0, _phoneInputHelpers.parsePhoneNumber)('+870773111632', _metadata.default);
    (0, _phoneInputHelpers.getInitialPhoneDigits)({
      value: phoneNumber.number,
      defaultCountry: 'RU',
      useNationalFormat: true,

...
import { getPreSelectedCountry, getCountrySelectOptions, parsePhoneNumber, generateNationalNumberDigits, getPhoneDigitsForNewCountry, getInitialPhoneDigits, onPhoneDigitsChange, e164 } from './helpers/phoneInputHelpers.js';
...
class PhoneNumberInput_ extends React.PureComponent {
  constructor(props) {
    ...
    _defineProperty(this, "onCountryChange", newCountry => {
      ...
      const newValue = e164(newPhoneDigits, newCountry, metadata); // Focus phone number `<input/>` upon country selection.
    ...
    const phoneNumber = parsePhoneNumber(_value, _metadata);
...
const PhoneNumberInput = /*#__PURE__*/React.forwardRef((props, ref) => /*#__PURE__*/React.createElement(PhoneNumberInput_, _extends({}, props, {
  inputRef: ref
})));
